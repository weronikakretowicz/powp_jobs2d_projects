...
public class ScallingLineDriverAdapter implements Job2dDriver {
    ...
    public ScallingLineDriverAdapter(DrawPanelController drawController, ILine line, String name, int scalingFactor) {
        super();
